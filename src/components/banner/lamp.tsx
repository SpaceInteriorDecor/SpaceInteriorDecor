  ...
  return (
    <LampContainer>
      <div className="py-[20rem] mt-8">
        ...
        <FadeInHeader className="bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl p-0">
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[40vh] flex-col items-center justify-center overflow-hidden bg-gray-900 w-full rounded-md z-0 mb-[10rem]",
        className
      )}
    >
